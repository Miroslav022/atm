      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row align-items-center">
            <div class="col-5">
              <h4 class="page-title">Gradovi</h4>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
            <a href="../operationsPage/dodaj.php?page=grad" class="btn btn-primary mb-3">Dodaj Grad</a>
              <div class="card">
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      <caption>Lista gradova</caption>
                      <thead>
                        <tr>
                          <th scope="col">#</th>
