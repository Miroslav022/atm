      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row align-items-center">
            <div class="col-5">
              <h4 class="page-title">Upravljaj Državama</h4>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <a href="../operationsPage/dodaj.php?page=drzava" class="btn btn-primary mb-3">Dodaj Državu</a>
              <div class="card">
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      <caption>Lista država</caption>
                      <thead>
                        <tr>
                          <th scope="col">#</th>
