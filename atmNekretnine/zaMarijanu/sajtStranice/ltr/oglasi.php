    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              <a href="../operationsPage/dodaj.php?page=oglas" class="btn btn-primary mb-3">Dodaj oglas</a>
              <div class="card">
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      <caption>Lista Naselja</caption>
                      <thead>
                        <tr>
                          <th scope="col">#</th>
                    ...
                    <div class="pagination-btns">
                      <a href="" class="btn btn-primary back">Nazad</a>
                      <a href="" class="btn btn-primary next">Dalje</a>
                    </div>
                  </div>
                </div>
              </div>
