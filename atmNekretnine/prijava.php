...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700" rel="stylesheet"><link rel="stylesheet" href="assets/css/login.css">
...
<body class="align">
  ...
  <div class="grid">
    ...
    <form action="models/login/login.php" method="POST" class="form login">
